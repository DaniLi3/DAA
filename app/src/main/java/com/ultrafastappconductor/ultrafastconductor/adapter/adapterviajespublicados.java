...
import com.ultrafastappconductor.ultrafastconductor.Activitys.ModuloMisPublicaciones.TapViajesPublicados.DetallesViajePublicado;
...
public class adapterviajespublicados extends FirebaseRecyclerAdapter<ViajesPublicados, adapterviajespublicados.ViewHolder> {
    ...
    public adapterviajespublicados(@NonNull FirebaseRecyclerOptions<ViajesPublicados> options,Context context) {
        super(options);
    ...
    @Override
    protected void onBindViewHolder(@NonNull adapterviajespublicados.ViewHolder holder, int position, @NonNull ViajesPublicados model) {
        ...
        String [] formatiarfechasalida=fechasalida.split(" ");
        ...
        holder.fecha.setText("Salida: "+fechasalida);
        holder.kilos.setText("Peso disponible: "+peso+" kg");
        ...
        holder.mview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent=new Intent(mcontex, DetallesViajePublicado.class);
