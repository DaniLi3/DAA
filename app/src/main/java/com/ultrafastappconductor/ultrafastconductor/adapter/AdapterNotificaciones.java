...
import com.ultrafastappconductor.ultrafastconductor.Activitys.ModuloMisPublicaciones.Detalles.DetallesViajeAceptado;
...
public AdapterNotificaciones(@NonNull FirebaseRecyclerOptions<SolicitudesModel> options, Context context,String validar) {
    super(options);
...
protected void onBindViewHolder(@NonNull ViewHolder holder, int position, @NonNull SolicitudesModel model) {
    ...
    if (status.equals("creado"))
    {
        ...
        holder.estado.setTextColor(mcontex.getResources().getColor(R.color.teal_200));
