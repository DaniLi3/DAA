...
public class Choferprovider {
    ...
    public DatabaseReference getidentificacion(String idUsuario) {
        return mdatarefe.child(idUsuario).child("identificacion");
    }public DatabaseReference getlicencia(String idUsuario) {
        return mdatarefe.child(idUsuario).child("licencia");
    }
