package com.ultrafastappconductor.ultrafastconductor.Models;

public class SolicitudesCanceladasmodel {
    ...
    public String telpersonaquerecibe;
    ...
    public SolicitudesCanceladasmodel() {
    }

    public SolicitudesCanceladasmodel(String fechadesalida, String fechadesolicitud, String fechadepublicacionviaje, String origen, String destino, String idcliente, String idchofer, String idnoty, String status, String precio, String seo, String seocliente, String kilos, double origenLat, double origenLog, double destinoLatt, double destinoLog, long timestamp, String image, String personaquerecibe, String notapaquete, String contenidopaquete, String dimensiones,String idviaje) {
    ...
    public String getTelpersonaquerecibe() {
        return telpersonaquerecibe;
    }

    public void setTelpersonaquerecibe(String telpersonaquerecibe) {
        this.telpersonaquerecibe = telpersonaquerecibe;
    }
