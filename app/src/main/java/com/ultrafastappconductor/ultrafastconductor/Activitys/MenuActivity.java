...
import com.ultrafastappconductor.ultrafastconductor.Activitys.ModuloMisPublicaciones.PublicarViajeActivity.AvisoValidar;
...
import com.ultrafastappconductor.ultrafastconductor.Activitys.fragmentos.FrakmenPrincipal;
import com.ultrafastappconductor.ultrafastconductor.Activitys.fragmentos.ThirdFragment;
import com.ultrafastappconductor.ultrafastconductor.Activitys.fragmentos.Viajescercadeti;
...
import com.ultrafastappconductor.ultrafastconductor.Utils.VerificarConexionaInternet;
...
public class MenuActivity extends AppCompatActivity implements OnMapReadyCallback {
   ...
   // TabLayout tabLayout;
    ...
    FrakmenPrincipal firstFragment=new FrakmenPrincipal();
   ...
   private void prepareViewPague(ViewPager viewPager,ArrayList<String> arrayList) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Veriniciio=findViewById(R.id.verinicio);
       ...
       // tabLayout.setupWithViewPager(viewPager);
        ...
        if (bundle!=null)
        {
            ...
            FrakmenPrincipal fragInfo = new FrakmenPrincipal();
            ...
            if (loco!=null)
            {
                if (loco.equals("si"))
                {
                    Veriniciio.setVisibility(View.GONE);
        ...
        BottomNavigationView navigationView = findViewById(R.id.BottomNavigation);
        navigationView.setOnNavigationItemSelectedListener(mOnNavigationItemSelecedListener);
        Veriniciio.setVisibility(View.VISIBLE);
        ...
        public boolean onNavigationItemSelected(@NonNull MenuItem item) {
            switch (item.getItemId())
            {
                case R.id.navigation_home:
                   // loadFragment(firstFragment);
                    Intent intenttt = new Intent(MenuActivity.this, MenuActivity.class);
                ...
                case R.id.navigation_dashboard:
                    ...
                    Intent intentt = new Intent(MenuActivity.this, TapSolicitudes.class);
                ...
                case R.id.navigation_rec:
                    ...
                    Intent intent=new Intent(MenuActivity.this, TapViajesPublicados.class);
                    startActivity(intent);

                    return true;
                case R.id.navigation_publi:
        ...
        choferprovider.getusuario(authprovider.getid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists())
                {
                    ...
                    {
                        Intent intent=new Intent(MenuActivity.this, AvisoValidar.class);
                        startActivity(intent);
                    }
                    else
                    {
                        Intent inten = new Intent(MenuActivity.this, PublicarViajeOrigen.class);
                        startActivity(inten);
                    }
                }
            }
